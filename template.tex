...
\pagestyle{fancy}
\fancyhead[r]{EPI-089}
\fancyhead[l]{J.S. Quintero, J.A. Son}
...
\authorname[m]{Universidad El Bosque}{Facultad de Ingeniería}
\authordegree{Trabajo de Grado}
...
% use [f] for female and [m] for male
\adviser[f]{\textbf{Joan Sebastian Quintero Ceballos}}{\\& \textbf{José Armando Son Rojas}}{\\& Ingeniero en Telecomunicaciones \\& Ingeniero Electrónico}%{\\& Ingeniero Electrónico}
...
% use [f] for female and [m] for male
%\coadviser[f]{\textbf{}}{Ingeniero\\& Electrónico}{json@unbosque.edu.co}
...
\committee[c,m]{Jesús Rafael Cantillo Alzamora}
% Main raporteurs
...
\chapterfile{chapter9}
\chapterfile{chapter10}
\chapterfile{chapter11}
\chapterfile{chapter12}
\chapterfile{chapter13}
\chapterfile{chapter14}
\annexfile{annex1}
\annexfile{annex2}
\annexfile{annex3}
%\appendixfile{appendix1}
%\appendixfile{appendix2}
%\chapterfile{chapter15}
